/**
 * Lists all image files under public/assets/suorituskyvyt/02-merivoimat and writes
...
const NAVY_DIR = path.join(__dirname, '..', 'public', 'assets', 'suorituskyvyt', '02-merivoimat')
...
function walkDir(dir, basePath, acc) {
  ...
  for (const e of entries) {
    ...
    if (e.isDirectory()) {
      ...
      acc.push('/assets/suorituskyvyt/02-merivoimat/' + rel.replace(/\\/g, '/'))
    }
  }
}
