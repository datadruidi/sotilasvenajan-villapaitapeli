/**
 * Lists all image files under public/assets/sotilaspiirit/military-district-insignia and writes
...
const DIR = path.join(__dirname, '..', 'public', 'assets', 'sotilaspiirit', 'military-district-insignia')
...
function walkDir(dir, basePath, acc) {
  ...
  for (const e of entries) {
    ...
    if (e.isDirectory()) {
      ...
      acc.push('/assets/sotilaspiirit/military-district-insignia/' + rel.replace(/\\/g, '/'))
    }
  }
}
